...
"""
python vllm_client.py --model Qwen/Qwen3-8B-FP8 --workspace gptvj54 \
    --app-name example-vllm-inference --function-name serve \
    --max-tokens 1024 --temperature 0.7 --top-p 0.9 --top-k 0 \
    --prompt "Compose a limerick about baboons and racoons." \
    --system-prompt "You are a poetic assistant, skilled in writing satirical doggerel with creative flair."
